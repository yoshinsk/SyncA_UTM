# iso/kickstart/synca-utm-el8.ks
# Kickstart for the AlmaLinux 8.10 SyncA UTM installer variant.
...
SERVER_GUI_PYTHON=python3.9 /opt/synca-installer/synca-install.sh --postinstall
